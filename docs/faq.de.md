...
Darüber hinaus ist es immer möglich, dass wir eine falsche Zuordnung getroffen haben. In diesem Fall bitten wir um Rückmeldung eines konkreten Beispiels unter https://github.com/mfdz/transit-stops-osm-comparison/issues.
...
2. Wir versuchen bereits, den Ortsnamen vom Haltestellennamen abzuspalten und bei Vergleichen zu ignorieren, verwenden jedoch noch recht einfache Ansätze. Bei konkreten Änderungsvorschlägen gerne mit konkretem Beispiel über https://github.com/mfdz/transit-stops-osm-comparison/issues melden.
...
5. Es ist immer möglich, dass wir eine falsche Zuordnung getroffen haben. In diesem Fall bitten wir um Rückmeldung eines konkreten Beispiels unter https://github.com/mfdz/transit-stops-osm-comparison/issues .
...
4. Es ist immer möglich, dass wir eine falsche Zuordnung getroffen haben. In diesem Fall bitten wir um Rückmeldung eines konkreten Beispiels unter https://github.com/mfdz/transit-stops-osm-comparison/issues .
